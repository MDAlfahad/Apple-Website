...
function IPhone(props) {
  // Load GLTF with deployment-aware path
  ...
  useEffect(() => {
    Object.entries(materials).forEach(([name, material]) => {
      // Skip materials that shouldn't change
      if (![
        "zFdeDaGNRwzccye",
        "ujsvqBWRMnqdwPx",
        "hUlRcbieVuIiOXG",
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.xXDHkMplTIDAXLN.geometry} scale={0.01}>
